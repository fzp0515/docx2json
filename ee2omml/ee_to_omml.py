...
parser.add_argument('pandoc_exe_dir', type=str, help='pandoc.exe的绝对路径')

args = parser.parse_args()

DOCX_DIR = args.docx_dir
SAVE_DIR = args.save_dir
PANDOC_DIR=args.pandoc_exe_dir
...
def convert_docx_to_md(docx_file):
    ...
    try:
        ...
        subprocess.run([PANDOC_DIR, docx_file, '-o', md_file], check=True)
